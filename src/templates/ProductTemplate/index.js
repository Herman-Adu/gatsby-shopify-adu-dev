...
import { Layout, ImageGallary, ProductQuantityAdder, Button, SEO } from 'components'
...
export default function ProductTemplate(props) {
    ...
    const variantId = queryString.parse(search).variant; // pass in search fron useLocation
